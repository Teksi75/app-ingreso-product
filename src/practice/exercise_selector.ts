...
function resolveKnownSubskill(key: string, skillId: string): string | null {
  const rules: Array<[string, string, RegExp]> = [
    ...
    ["lengua.skill_1", "lengua.skill_1.subskill_4", /vocabulario|significado|acepcion|expresion|cotexto/],
    ["lengua.skill_1", "lengua.skill_1.subskill_5", /sinonimo|antonimo|intensidad|equivalencia|oposicion/],
    ["lengua.skill_1", "lengua.skill_1.subskill_2", /infer|causa|consecuencia|motivo|intencion|estado|pista/],
    ...
    ["lengua.skill_2", "lengua.skill_2.subskill_4", /clase textual|tipo textual|paratexto|biografia|noticia|leyenda|enciclopedico|cuento/],
    ["lengua.skill_2", "lengua.skill_2.subskill_5", /narrador|punto de vista|omnisciente|persona narrativa/],
    ...
    ["lengua.skill_4", "lengua.skill_4.subskill_4", /pronombre|posesivo|demostrativo|determinante/],
    ["lengua.skill_4", "lengua.skill_4.subskill_5", /adverbio|modificador/],
    ["lengua.skill_4", "lengua.skill_4.subskill_1", /categoria|gramatical|sustantivo|adjetivo|verbo/],
    ...
    ["lengua.skill_6", "lengua.skill_6.subskill_4", /diptongo|hiato|triptongo|silaba|concurrencia/],
    ["lengua.skill_6", "lengua.skill_6.subskill_5", /mayuscula|nombre propio/],
    ["lengua.skill_6", "lengua.skill_6.subskill_2", /acentuacion|tilde/],
