...
## Corpus Check
- 72 files · ~248,624 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 378 nodes · 685 edges · 51 communities detected
...
Cohesion: 0.07
Nodes (46): getSeenSkills(), buildFallbackOptions(), buildGeneratedOptions(), buildHighlightOptions(), buildObjectAnswerOptions(), buildOrderingOptions(), buildPlannedSessionExercises(), buildUserState() (+38 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (33): getPracticeProgressSnapshot(), getWeakestPracticeSkillId(), buildMasteryModel(), buildPracticeProgressSnapshot(), buildPracticeSkillStats(), buildTrace(), calculateMasteryScore(), clampMasteryLevel() (+25 more)
...
Cohesion: 0.2
Nodes (23): appendSessionResult(), cloneProgress(), createEmptyProgress(), createSessionId(), getProgressPath(), getRedisClient(), getRedisProgressKey(), getSeenSkillsAsync() (+15 more)
...
Cohesion: 0.18
Nodes (11): ActionPanel(), withNewStudentParam(), createEmptyProgress(), DashboardPage(), getParam(), SimulacionesPage(), withNewStudentParam(), withProgressCode() (+3 more)
...
Cohesion: 0.24
Nodes (12): markSkillsSeenAsync(), buildRestartHref(), PracticePage(), buildReadingBlockSessionExercises(), buildSkillTrainingPool(), createPracticeSelection(), getReadingUnitForPool(), pickReadingUnitCandidate() (+4 more)
...
- **Thin community `Community 32`** (1 nodes): `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `exercise_selector.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `session_runner.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 41`** (1 nodes): `reading_session_runner.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `skill_slugs.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `reading_unit.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `all-pages.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `dashboard-progress.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `dashboard-responsive.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `dashboard-screenshot.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `first-experience.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `lengua-practice-links.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `student-profile-and-code.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `GET()` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `buildMasteryModel()` connect `Community 1` to `Community 8`, `Community 7`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `loadLenguaExercises()` connect `Community 6` to `Community 0`, `Community 9`, `Community 2`, `Community 3`?**
