...
3. `selectNextExerciseDetailed()` - 16 edges
4. `loadLenguaExercises()` - 16 edges
5. `loadLenguaSelectionGraph()` - 14 edges
6. `loadProgressAsync()` - 14 edges
7. `normalizeExercise()` - 12 edges
8. `buildMasteryModel()` - 12 edges
9. `startPracticeSession()` - 11 edges
10. `loadProgress()` - 11 edges

## Surprising Connections (you probably didn't know these)
- `Practice Page (Tall Desktop Layout)` --semantically_similar_to--> `Practice Page (Desktop Layout)`  [AMBIGUOUS] [semantically similar]
  practice-desktop-tall.png → practice-desktop.png
- `Practice Page (Desktop Layout)` --semantically_similar_to--> `Practice Page (Desktop Layout Variant 2)`  [AMBIGUOUS] [semantically similar]
  practice-desktop.png → practice-desktop2.png
- `Practice Page (Desktop Layout)` --semantically_similar_to--> `Practice Page (Full Page)`  [AMBIGUOUS] [semantically similar]
  practice-desktop.png → practice-fullpage.png
- `Glossary Panel (Expanded)` --semantically_similar_to--> `Glossary Panel (Collapsed)`  [AMBIGUOUS] [semantically similar]
  practice-glossary-clicked.png → practice-glossary-closed.png
- `Glossary Expanded UI` --semantically_similar_to--> `Glossary UI`  [AMBIGUOUS] [semantically similar]
  practice-glossary-open.png → practice-glossary.png
...
- **Reading Stimulus Design Decision** — skill_first_model, text_group_stimulus, trainable_skills [INFERRED]
- **Pedagogical Core Principles** — skill_first_model, feedback_principles, cognitive_load_rules [INFERRED]
- **Reading unit ecosystem: candidates, packs, and engine** —  [INFERRED 0.80]
...
- **Agent pipeline evolution from documentary to operative** —  [EXTRACTED 0.90]
- **TextGroup implementation path from limitation to execution** —  [EXTRACTED 1.00]
- **Weak Skill Strengthening System** — mastery_model_state_machine, get_next_step_recommendation, skill_states [INFERRED]
...
Cohesion: 0.22
Nodes (8): Adaptivity Limitation in UI, CLI runSession() with full adaptivity, selectNextExerciseDetailed(), Shared selection function for client/server, L2: Random replaces adaptivity in UI, Etapa D: Adaptivity for UI outside groups, Step 4: Replace random with adaptive selector, UI de pregunta de practica
...
Cohesion: 0.25
Nodes (8): Agent System (Documental), Codex Prompt Generator Agent, Product Guardian Agent, Quality Auditor Agent, Scope & Rules Validator Agent, Stage 6: Executable Agents Phase 1, Stage 7: Executable Agents Phase 2, Product Vision

### Community 21 - "Community 21"
Cohesion: 0.36
Nodes (8): Practice Page (Tall Desktop Layout), Practice Page (Desktop Layout Variant 2), Practice Page (Desktop Layout), Practice Page (Full Page), Glossary Panel (Expanded), Glossary Panel (Collapsed), Glossary Feature, Responsive Desktop Layout
...
- `Canonical Text Pack V1` → `L5: Dual ID system (LEGACY_SKILL_IDS)`  [AMBIGUOUS]
  docs/analysis_codex/03_limitations_validation.md · relation: conceptually_related_to
- `Practice Page (Tall Desktop Layout)` → `Responsive Desktop Layout`  [AMBIGUOUS]
  practice-desktop-tall.png · relation: implements
- `Practice Page (Tall Desktop Layout)` → `Practice Page (Desktop Layout)`  [AMBIGUOUS]
  practice-desktop.png · relation: semantically_similar_to
- `Practice Page (Desktop Layout)` → `Responsive Desktop Layout`  [AMBIGUOUS]
  practice-desktop.png · relation: implements
- `Practice Page (Desktop Layout)` → `Practice Page (Desktop Layout Variant 2)`  [AMBIGUOUS]
  practice-desktop.png · relation: semantically_similar_to
- `Practice Page (Desktop Layout)` → `Practice Page (Full Page)`  [AMBIGUOUS]
  practice-fullpage.png · relation: semantically_similar_to
- `Practice Page (Desktop Layout)` → `Glossary Panel (Expanded)`  [AMBIGUOUS]
  practice-glossary-clicked.png · relation: conceptually_related_to
- `Responsive Desktop Layout` → `Practice Page (Desktop Layout Variant 2)`  [AMBIGUOUS]
  practice-desktop2.png · relation: implements
- `Glossary Panel (Expanded)` → `Glossary Feature`  [AMBIGUOUS]
  practice-glossary-clicked.png · relation: implements
- `Glossary Panel (Expanded)` → `Glossary Panel (Collapsed)`  [AMBIGUOUS]
  practice-glossary-clicked.png · relation: semantically_similar_to
- `Glossary Feature` → `Glossary Panel (Collapsed)`  [AMBIGUOUS]
  practice-glossary-closed.png · relation: implements
- `Glossary Expanded UI` → `Glossary UI`  [AMBIGUOUS]
  practice-glossary-open.png · relation: semantically_similar_to
- `Glossary UI` → `Practice Main UI`  [AMBIGUOUS]
  practice-screenshot.png · relation: conceptually_related_to
- `Mobile Fix UI` → `Mobile UI`  [AMBIGUOUS]
  practice-mobile-fix.png · relation: rationale_for
- `Mobile UI` → `Practice Main UI`  [AMBIGUOUS]
  practice-mobile.png · relation: conceptually_related_to
- `Practice Main UI` → `Practice Secondary UI`  [AMBIGUOUS]
  practice-screenshot2.png · relation: conceptually_related_to
...
- **What is the exact relationship between `Canonical Text Pack V1` and `L5: Dual ID system (LEGACY_SKILL_IDS)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Practice Page (Tall Desktop Layout)` and `Responsive Desktop Layout`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **What is the exact relationship between `Practice Page (Tall Desktop Layout)` and `Practice Page (Desktop Layout)`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **What is the exact relationship between `Practice Page (Desktop Layout)` and `Responsive Desktop Layout`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **What is the exact relationship between `Practice Page (Desktop Layout)` and `Practice Page (Desktop Layout Variant 2)`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **What is the exact relationship between `Practice Page (Desktop Layout)` and `Practice Page (Full Page)`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **What is the exact relationship between `Practice Page (Desktop Layout)` and `Glossary Panel (Expanded)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._